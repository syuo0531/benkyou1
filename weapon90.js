(function(){
'use strict';
/* v9.0 exact generated pixel-art sprite patch. Visual only. */
...
function sprite(g,large){const p=info(g);if(!p)return'';const other=p.row===10;return `<span class="weapon90-sprite${large?' large':''}${other?' other':''}" style="--c:${p.col};--r:${p.row}" aria-hidden="true"></span>`;}
